...
public class AnimalFilter implements IAnimalFilter {
    ...
    public void filterOnType(String filterStr) {
        filtered = filtered.stream()
                .filter(animal -> animal.getAnimalType().name().equalsIgnoreCase(filterStr))
    ...
    public void filterOnSpecies(String filterStr) {
        filtered = filtered.stream()
                .filter(animal -> animal.getSpecies().toString().equalsIgnoreCase(filterStr))
                .collect(Collectors.toList());
    }
    ...
    public void filterOnSize(String filterStr) {
        filtered = filtered.stream()
                .filter(animal -> animal.getAnimalSize().toString().equalsIgnoreCase(filterStr))
                .collect(Collectors.toList());
    }
    ...
    public void filterOnGender(String filterStr) {
        filtered = filtered.stream()
                .filter(animal -> animal.getGender().toString().equalsIgnoreCase(filterStr))
                .collect(Collectors.toList());
    }
    ...
    public void filterOnPattern(String filterStr) {
        filtered = filtered.stream()
                .filter(animal -> animal.getPattern().toString().equalsIgnoreCase(filterStr))
                .collect(Collectors.toList());
    }
    ...
    public void filterOnColor(String filterStr) {
        filtered = filtered.stream()
                .filter(animal -> animal.getAnimalColor().toString().equalsIgnoreCase(filterStr))
                .collect(Collectors.toList());
    }
    ...
    public void filterOnAge(String filterStr) {
        filtered = filtered.stream()
                .filter(animal -> animal.getAnimalAge().toString().equalsIgnoreCase(filterStr))
                .collect(Collectors.toList());
    }
    ...
    public void filterOnArea(String filterStr) {
        filtered = filtered.stream()
                .filter(animal -> animal.getArea().toString().equalsIgnoreCase(filterStr))
                .collect(Collectors.toList());
    }
