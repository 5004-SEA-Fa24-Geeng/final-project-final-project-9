...
public class Hedgehog extends Animal {
     ...
     */
    public Hedgehog(String type, String species, String size, String gender, String pattern, String color, String age, String address, String area, String time, String seenDate, String description, String locDesc, String number, String fileSrc) {
    ...
    public String[] getSpeciesOfThisType() {
        Species[] species = Hedgehogs.values();
